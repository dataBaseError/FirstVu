...
bool Transaction::buy(string buyName, string event, int numTickets, string sellName) {
    throw "Not yet implemented";
}

bool Transaction::sell(string sellName, string event, double salePrice, int availTicket) {
    throw "Not yet implemented";
}

bool Transaction::create(string newUser, string accountType, double accountBalance) {
    throw "Not yet implemented";
}
