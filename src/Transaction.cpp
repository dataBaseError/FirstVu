...
bool Transaction::buy(string event, int numTickets, string sellName) {
	...
	// Buy Start
	cout << "cost per ticket: $" << setiosflags(ios::fixed) << setprecision(2) << eventTickets.getCost() << endl;
	cout << "total cost: $" << setiosflags(ios::fixed) << setprecision(2) << cost << endl;
	cout << "current balance: $" << setiosflags(ios::fixed) << setprecision(2) << buyer.getBalance() << endl;
